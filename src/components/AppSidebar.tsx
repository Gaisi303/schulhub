...
export function AppSidebar() {
  ...
  return (
    <>
              ...
              <SidebarMenu>
                ...
                <SidebarMenuItem>
                  <SidebarMenuButton
                    ...
                    tooltip="Lern-AI"
                    className="!text-sidebar-foreground hover:bg-sidebar-accent hover:!text-sidebar-accent-foreground [&>span]:!text-current [&>svg]:!text-current"
                  >
      ...
      <LernChat open={chatOpen} onOpenChange={setChatOpen} />
    </>
  );
}
